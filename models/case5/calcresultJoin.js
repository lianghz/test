...
var salesModel = mongoose.model('case5sales', salesSchema, 'case5sales');
var deliverModel = mongoose.model('case5deliver2', deliverSchema, 'case5delivers');
var checkResultModel = mongoose.model('case5checkresult2', checkResultSchema, 'case5checkresults');
var activeModel = mongoose.model('case5active2', activeSchema, 'case5actives');
...
function getDataForExcel(req, res, cb) {
    params.paramNoDb("case5calcResultExcel", function (result) {
...
function savecase5Version(req, res, cb) {
    var period = req.body.period;
    var vno = req.body.vno;
    var vname = req.body.vname;
    var collectionName = 'case5result' + period + 'v' + vno;
    var collectionsaveName = 'case5saveresult' + period + 'v' + vno;
    ...
    params.paramNoDb("versions", function (fields) {
        ...
        nonKaModel.remove({}, function (err, result) {
            getCalcResult(req, res, function (docs) {
                ...
                params.getHeader('case5', function (header) {
...
///获取grid表头格式
function getGrid(cb) {
    params.paramNoDb("case5calcResultGrid", function (result) {
        cb(result);
    });
}
...
var methods = {
    ...
    'savecase5Version': savecase5Version,
